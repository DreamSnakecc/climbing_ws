...
//	static CAN_RxHeaderTypeDef 		Rx1Message;
  ...
  CAN_FilterConfigStructure.FilterBank=0;
	...
	CAN_FilterConfigStructure.FilterIdHigh = 0x0;//0x201 << 5;
	CAN_FilterConfigStructure.FilterIdLow = 0x0 ;
	CAN_FilterConfigStructure.FilterMaskIdHigh = 0x0;
	CAN_FilterConfigStructure.FilterMaskIdLow = 0x0;
...
//	CAN_FilterConfigStructure.FilterIdHigh = 0x205 << 5;
//	CAN_FilterConfigStructure.FilterIdLow = 0x206 << 5;
//	CAN_FilterConfigStructure.FilterMaskIdHigh = 0x207 << 5;
//	CAN_FilterConfigStructure.FilterMaskIdLow = 0x208 << 5;
//	CAN_FilterConfigStructure.FilterFIFOAssignment = CAN_RX_FIFO0;
//	CAN_FilterConfigStructure.SlaveStartFilterBank=14;
////	CAN_FilterConfigStructure.SlaveStartFilterBank = 14;//can1(0-13)和can2(14-27)分别得到一半的filter
//	CAN_FilterConfigStructure.FilterActivation = ENABLE;
...
////	}
  ...
  CAN_FilterConfigStructure.FilterBank=14;
	...
	CAN_FilterConfigStructure.FilterMaskIdHigh = 0x0;
	CAN_FilterConfigStructure.FilterMaskIdLow = 0x0;;
	CAN_FilterConfigStructure.FilterFIFOAssignment = CAN_RX_FIFO1;
	CAN_FilterConfigStructure.SlaveStartFilterBank=14;
//	CAN_FilterConfigStructure.SlaveStartFilterBank = 14;//can1(0-13)和can2(14-27)分别得到一半的filter
	CAN_FilterConfigStructure.FilterActivation = ENABLE;
 if(hcan == &hcan2)
...
//	CAN_FilterConfigStructure.FilterBank=15;
//	CAN_FilterConfigStructure.FilterMode = CAN_FILTERMODE_IDLIST;
//	CAN_FilterConfigStructure.FilterScale = CAN_FILTERSCALE_16BIT;
//	CAN_FilterConfigStructure.FilterIdHigh = 0x205 << 5;
//	CAN_FilterConfigStructure.FilterIdLow = 0x206 << 5;
